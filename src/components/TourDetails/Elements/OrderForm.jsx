    ...
    return (
        <div className="py-8 overflow-y-scroll hiddenScrollBar w-[90%] max-w-screen-lg">
            <div
                ...
                className="bg-white  rounded-md p-4 md:p-8 font-montserrat"
            >
                <div>
                    <div className="flex justify-between items-center">
                        <p className="text-2xl md:text-3xl font-semibold">
                            {lang === "rus" ? tour?.title : tour?.titleEng}
                        </p>
                        <svg
                    ...
                    <p className="text-base md:text-xl font-normal mt-2 md:mt-4">
                        {lang === "rus" ? tour?.slogan : tour?.sloganEng}
                    </p>
                    ...
                    <div className="mt-4 md:mt-8 grid grid-cols-4 gap-x-1 md:grid-rows-1">
                        ...
                        <div className="flex items-center justify-between md:flex-col col-span-4 md:col-span-1">
                            <label
                                className="font-semibold text-left text-[#00499f]"
                                htmlFor="datePicker"
                            >
                        ...
                        <div className="flex justify-between items-center md:flex-col col-span-4 md:col-span-1">
                            <label
                                className="font-semibold text-left text-[#00499f]"
                                htmlFor="datePicker"
                            >
