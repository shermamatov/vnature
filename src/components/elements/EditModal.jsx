...
const EditModal = ({
    ...
    return (
        ...
        >
            ...
            <label
                htmlFor="inputname"
                className="text-sm text-red-500 font-normal leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
            >
                *тут для переноса строки используйте также знак " ; " не
                используйте его больше нигде кроме места разделения
            </label>
            <textarea
                value={desc}
