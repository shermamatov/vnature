...
const EditTour = () => {
    ...
    useEffect(() => {
        ...
        setTitleEng(oneTour?.titleEng);
        setSlogan(oneTour?.slogan);
        setSloganEng(oneTour?.sloganEng);
        setDescription(oneTour?.description);
        setDescriptionEng(oneTour?.descriptionEng);
        setLevel(oneTour?.level);
        setDays(oneTour?.daysCount);
        setAge(oneTour?.age);
        ...
        setMemoriesEng(oneTour?.memoriesEng);
        setOptional(oneTour?.optional || []);
            ...
            <div className="content pb-32">
                ...
                <div>
                    ...
                    <div className="mt-2 p-2 shadowInput backdrop-blur-sm">
                        ...
                        <button
                            className="input relative cursor-pointer"
                    ...
                    <div className="mt-2 p-2 shadowInput backdrop-blur-sm">
                        ...
                        {langChecker(programmDays, programmDaysEng)?.map(
                            (item, index) => (
                                <AccordionElement
                                    key={index}
                                    item={item}
                    ...
                    <div className="mt-2 p-2 shadowInput backdrop-blur-sm">
                        ...
                        <br />
                        {langChecker(important, importantEng)?.map(
                            (item, index) => (
                                <AccordionElement2
                                    key={index}
                                    item={item}
                    ...
                    <div className="mt-2 p-2 shadowInput backdrop-blur-sm">
                        ...
                        <br />
                        {langChecker(optional, optionalEng)?.map(
                            (item, index) => (
                                <AccordionElement2
                                    key={index}
                                    isModal={true}
